...
export function Footer() {
  return (
    <footer className="border-t border-border bg-[#03040e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Launching brands into the next digital orbit with AI-powered strategies and creative excellence.
            </p>
            ...
            <ul className="space-y-2">
              {footerLinks.company.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-muted-foreground hover:text-[#38bdf8] transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">
            &copy; {new Date().getFullYear()} Xmatic Digital. All rights reserved.
          </p>
